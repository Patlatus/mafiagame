...
try {
    ...
    $log->lwrite("Add base line chat line");
}
catch (Exception $e) {
    echo $e->getMessage();
...
try {
    ...
    $addsql="insert into ".$bcl." (userid, username, text, time) values ('".$userid."', '".$username."', '".$text."', ".time().")";
    $log->lwrite("userid=".$userid."username=".$username."text=".$text."\nsql=".$addsql);
